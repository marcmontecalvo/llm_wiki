...
```
python3.11 {skill-root}/scripts/list_customizable_skills.py --project-root {project-root}
```
...
4. Verify:
   ```
   python3.11 {project-root}/_bmad/scripts/resolve_customization.py --skill <install-path> --key <agent-or-workflow>
   ```
