...
RUN chmod +x /docker-entrypoint.sh && mkdir -p /var/log/llm-wiki /app/wiki_system/logs /var/run && chown -R llmwiki:llmwiki /var/log/llm-wiki /app/wiki_system /var/run && mkdir -p /app/config
